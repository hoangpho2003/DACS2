    ...
    <div class="section-title-01 honmob">
        ...
        <div class="opacy_bg_02">
            <div class="container">
                ...
                <div class="crumbs">
                    <ul>
                        <li><a href="/HomeServices/public/">Home</a></li>
                        <li>/</li>
                        <li>Registeration</li>
                    </ul>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-md-offset-3 profile1" style="padding-bottom:40px;">
                        <div class="thinborder-ontop">
                            ...
                            <form id="userregisterationform" method="POST" accept="{{route('register')}}"> 
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-md-4 col-form-label text-md-right">Gmail</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="registeras" id="registeras" class="form-control">
                                            ...
                                            <option value="Sprovider">Services Provider</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
